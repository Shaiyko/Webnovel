...
const ReportUsers = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const { results, typerepostg, typereposte, typereposts, typerepostr, quantityu } = response.data;
      setReports(results);
  ...
  const handleExport = () => {
    window.location.href = `http://localhost:5000/exportsuggestions?genderSearch=${genderSearch}&startDate=${startDate}&endDate=${endDate}`;
  };
        ...
        >
          ...
          <FormControl sx={{ width: "250px" }} variant="outlined">
            ...
            <MenuItem value="Errors of the Novel">Errors of the Novel</MenuItem>
              <MenuItem value="Suggestions for this Novel">Suggestions for this Novel</MenuItem>
